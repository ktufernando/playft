/*
 * SampleFilePublicKeyDataProvider.java from LicenseManager modified Monday, March 5, 2012 22:05:18 CST (-0600).
 *
...
/**
 * MyFilePublicKeyDataProvider.java
 *
 * PLAYFT.
 *
...
public class MyFilePublicKeyDataProvider implements PublicKeyDataProvider {
	/**
	...
	public byte[] getEncryptedPublicKeyData() throws KeyNotFoundException {
		try {
			return IOUtils.toByteArray(
					new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("playft.public.key"), "ISO-8859-1"),
					"ISO-8859-1"
			);
		}
		catch(IOException e) {
